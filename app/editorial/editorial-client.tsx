...
export default function EditorialClient({records}:{records:EditorialRecord[]}){
  ...
  return <section className="editorial-queue" id="queue"><div className="editorial-head"><div><p className="eyebrow">Seed migration queue</p><h2>Review the evidence before the interface.</h2></div><p>This queue audits database readiness only. “Ready for import” does not mean the claim has passed the protected two-person publication workflow.</p></div>
